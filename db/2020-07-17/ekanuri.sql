...
--
-- Host: localhost
-- Generation Time: Jul 17, 2020 at 07:39 
...
CREATE TABLE IF NOT EXISTS `job_ordertruck` (
  ...
  `satuan_jenis` varchar(11) NOT NULL,
  `ton_cargo` decimal(6,2) NOT NULL,
  `p_cargo` decimal(6,2) DEFAULT NULL,
  `l_cargo` decimal(6,2) DEFAULT NULL,
  `t_cargo` decimal(6,2) DEFAULT NULL,
  `volume_cargo` decimal(6,2) DEFAULT NULL,
  `revton_cargo` decimal(6,2) DEFAULT NULL,
  `deskripsi_cargo` text NOT NULL,
  `status_cargo` varchar(15) NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `job_ordertruck` (`id_jobordertruck`, `id_alatberat`, `id_client`, `nm_company`, `production`, `nm_kegiatan`, `no_po`, `id_jenis`, `qty_cargo`, `satuan_jenis`, `ton_cargo`, `p_cargo`, `l_cargo`, `t_cargo`, `volume_cargo`, `revton_cargo`, `deskripsi_cargo`, `status_cargo`) VALUES
('', 8, 3, 'PT.ASW', 'Production', 'LOADING', '0001', 96, 1, '0', '1.00', '1.00', '1.00', '1.00', '0.00', '1.00', 'Loading Clamp Medco', '1'),
('JT00001', 8, 3, 'PT.ASW', 'Production', 'LOADING', '0001', 96, 1, '0', '1.00', '1.00', '1.00', '1.00', '0.00', '1.00', 'Loading Pallet Medco', '1'),
('JT00002', 8, 3, 'PT.ASW', 'Production', 'LOADING', '0001', 97, 1, 'Box', '1.00', '0.80', '0.60', '0.60', '0.29', '1.00', 'Loading Pallet Medco', '1'),
('JT00003', 7, 2, 'PT.ASW', 'Production', 'OFFLOADING', '0002', 72, 1, 'Rack', '2.00', '1.10', '1.05', '2.18', '2.52', '2.52', 'Offloading Premier', '1'),
('JT00004', 8, 3, 'PT.ASW', 'Production', 'LOADING', '0001', 29, 1, 'Palet', '1.00', '1.20', '1.20', '1.00', '1.44', '1.44', 'Loading Pallet Medco', '1'),
('JT00005', 6, 3, 'PT.ASW', 'Production', 'LOADING', '0002', 107, 1, 'UNIT', '20.00', '3.00', '2.44', '2.50', '18.30', '20.00', 'Loading Clamp Medco', '1');
