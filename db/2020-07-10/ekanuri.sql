...
--
-- Host: 127.0.0.1
-- Generation Time: 10 Jul 2020 pada 08.26
-- Versi Server: 5.6.21
-- PHP Version: 5.6.3
...
(85, 'Freed Pump', '2.50', '0.60', '0.80', 'UNIT', '1.20'),
...
(89, 'Feed Pump ', '2.50', '0.62', '0.84', 'UNIT', '1.30'),
...
('JV00009', 'KM.Sokka', 'PT.Global Trans', '2020-07-10', '06:00:00', '0000-00-00', '00:00:00', 'Matak', 'Jakarta', 1, 'Offloading', 2, 'Email tanggal 08 Juli 2020', '0', '406.76', 'JETTY KJ1', 'PTW Premier Oil New.pdf', 'PTW Premier Oil PJSM.pdf', 'List Personil & HDE New.xlsx', 'Crane R34 cap 60 Ton', 'Forklift F14 cap 3 Ton', 'Forklift F18 cap 8 Ton', 'Forklift F10 cap 3,5 Ton', 'NULL', 'NULL', 'kj1', '91.39', '2020-07-10 09:21:08', '2020-07-10 11:38:21', '2 jam 17 menit ', 4, NULL),
...
--
ALTER TABLE `actual_stevedoring`
MODIFY `id_as` bigint(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=96;
--
...
--
ALTER TABLE `jenis_barang`
MODIFY `id_jenis` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=100;
--
