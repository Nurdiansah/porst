...
--
-- Host: 127.0.0.1
-- Generation Time: 11 Agu 2020 pada 04.00
-- Versi Server: 5.6.21
-- PHP Version: 5.6.3
...
(20, 'JT00012', 'PT.Pusuma', 'Pallet flang', 'OFFLOADING', 'Production', '003', '0.20', '0.15', '0.10', '0.00', '0.35', '0.01', '1.05', '1.05', 3, 'Pallet', 'Off loading truck premier oil', 1),
...
(24, 'JT00013', 'PT.Mesitrch', 'Welding machine', 'OFFLOADING', '', '007', '2.00', '1.20', '1.80', '4.32', '1.30', '43.20', '13.00', '43.20', 10, 'Unit', 'Off loading truck premier oil', 1),
(25, 'JT00014', 'PT.Mesitech', 'Compressor', 'OFFLOADING', 'Production', '008', '2.57', '1.80', '1.83', '8.47', '1.70', '42.33', '8.50', '42.33', 5, 'Unit', 'Off loading truck premier oil', 1);
...
(147, 'PC Mex Lenovo', '0.90', '0.20', '0.50', 'W/Box', '0.09'),
...
('JT00012', 18, 2, 'kj1', NULL, '2020-08-10 14:42:07', NULL, NULL, NULL, NULL, NULL, '1'),
('JT00013', 18, 2, 'kj1', NULL, '2020-08-10 17:00:50', NULL, NULL, NULL, NULL, NULL, '1'),
('JT00014', 18, 2, 'kj1', NULL, '2020-08-10 17:05:43', NULL, NULL, NULL, NULL, NULL, '1');
...
--
ALTER TABLE `actual_jobordertruck`
MODIFY `id_at` int(12) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=48;
--
...
--
ALTER TABLE `actual_stevedoring`
MODIFY `id_as` bigint(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=736;
--
...
--
ALTER TABLE `detail_jobordertruck`
MODIFY `id_djotruck` int(12) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=26;
--
...
--
ALTER TABLE `jenis_barang`
MODIFY `id_jenis` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=149;
--
