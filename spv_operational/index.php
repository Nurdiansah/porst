...
include "../fungsi/koneksi.php";
 ...
 if(!isset($_SESSION['username']) || $_SESSION['level'] != 'asisten_manajer'){
...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">      
      <ul class="sidebar-menu">
        <li ><h4 class="text-center"><?php echo $Nama ?></h4></li>
        <li ><h4 class="text-center">Supervisor Operational</h4></li>
        ...
        <li class="treeview">
          <a href="index.php?p=datapesanan">
            ...
            <span>Job Order Vessel</span>
            <!-- <span class="pull-right-container">
              <span class="label label-primary pull-right"><?= $data['jumlah']; ?></span>
            </span> -->
          </a>
		      <ul class="treeview-menu">
            <li><a href="index.php?p=data_jovessel" ><i class="fa fa-files-o"></i>Approve Job Order</a></li>
            <li><a href="index.php?p=lihat_jovessel" ><i class="fa fa-files-o"></i>Lihat Job Order</a></li>
          </ul>
        </li>
  ...
  <footer class="main-footer">    
	<marquee hspace="40" width="full-width">Supervisor Operational Kalijapat</marquee>
