...
<section class="content-header">
    <h1>
        ...
        <small>Pekerjaan Stevedoring Vessel di PT. Nurdiansah Bongkar Muat yang sedang berlangsung </small>
    </h1>
    <ol class="breadcrumb">
            ...
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    <div class="col-sm-offset-">
                        ...
                        <button class="btn btn-success" type="button" data-toggle="collapse" data-target="#cargo" aria-expanded="false" aria-controls="collapseExample">
                        ...
                        <table class="table text-center table table-striped table-hover" id="">
                            ...
                            <tbody>
                                <tr>
                                    <td>1</td>
                                    <td>
                                        <?php if ($mulai_kegiatan == '01-January-1970 07:00:00') {
                                            echo "-";
                                        } else {
                                            echo $mulai_kegiatan;
                                        } ?>
                                    ...
                                    <td>
                                        <?php if ($finish_kegiatan == '01-January-1970 07:00:00') {
                                            echo "-";
                                        } else {
                                            echo $finish_kegiatan;
                                        } ?>
                                    </td>
                                    <td><?= $kegiatan ?></td>
                                    <td><b><?= $selisihK ?></b></td>
                ...
                <!-- Progress Cargo  -->
                <div class="collapse in" id="cargo">
                    <br><br>
                    <hr>
