...
if (isset($_POST['simpan'])) {
	...
	$query = "INSERT INTO detail_joborder ( id_joborder, id_cargo, id_jenis, doc_no, qty_cargo, rincian_cargo, m3_cargo, ton_cargo, revton_cargo, remarks_cargo, status_cargo) VALUES 
										( '$id_joborder', '$id_cargo', '$id_jenis', '$doc_no', '$qty_cargo', '$rincian_cargo', '$m3_cargo', '$ton_cargo', '$revton_cargo', '$remarks_cargo', 1);
			";
