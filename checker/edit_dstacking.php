...
if (isset($_POST['add'])) {
    ...
    $hasil1 = mysqli_query($koneksi, "UPDATE detail_stacking
    ...
    // query actual 
    $queryActual = mysqli_query($koneksi, "SELECT *  FROM actual_stacking WHERE id_cargo = '$id_cargo'");
    ...
    if (mysqli_num_rows($queryActual)) {
        foreach ($queryActual as $key) {
            ...
            mysqli_query($koneksi, "UPDATE actual_stacking
