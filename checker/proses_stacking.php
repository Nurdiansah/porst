...
$query = mysqli_query($koneksi, "SELECT * FROM stacking s
                                              ...
                                              WHERE s.status_stacking <= '2' AND s.id_checker = '$id_user'
                                              ");
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        ?>
                                                ...
                                                <td>
                                                    <a href="?p=detail_prosesstacking&id=<?= base64_encode($row['id_stacking']); ?>"><button class="btn btn-info"> Update </button></a>
                                                </td>
                                    </tr>
                            <?php $no++;
                                            endwhile;
