...
if (isset($_POST['add'])) {
    ...
    $hasil1 = mysqli_query($koneksi, "UPDATE detail_jobordertruck 
    ...
    // query actual 
    $queryActual = mysqli_query($koneksi, "SELECT *  FROM actual_jobordertruck WHERE id_djotruck = '$id_djotruck'");
    ...
    if (mysqli_num_rows($queryActual)) {
        foreach ($queryActual as $key) {
            ...
            mysqli_query($koneksi, "UPDATE actual_jobordertruck 
