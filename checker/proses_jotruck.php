...
$query = mysqli_query($koneksi, "SELECT * FROM job_ordertruck jo
                                              ...
                                              WHERE status_jotruck <= '2' AND id_checker = '$id_user'
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        ?>
                                                ...
                                                <td>
                                                    <a href="?p=detail_prosestruck&id=<?= base64_encode($row['id_jobordertruck']); ?>"><button class="btn btn-info"> Update </button></a>
                                                </td>
                                    </tr>
                            <?php $no++;
                                            endwhile;
                                        ...
                                        <form method="post" name="form" id="insert_form" enctype="multipart/form-data" action="add_jotruck.php" class="form-horizontal">
                                            <div class="box-body">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-5">
                                                        <select name="id_alatberat" class="form-control" required>
                                                ...
                                                <div class="form-group">
                                                    <label id="tes" for="client" class="col-sm-offset-1 col-sm-3 control-label">Area</label>
                                                    <div class="col-sm-5">
                                                        <select name="area" class="form-control" required>
                                                            <?php if ($Area == 'kj4') {
                                                                echo "<option value='kj4'>" . strtoupper($Area) . "</option>";
                                                            } else {
                                                                echo "<option value=''>--Pilih Area--</option>";
                                                                echo "<option value='kj1' type='checkbox'>KJ1</option>";
                                                                echo "<option value='kj2' type='checkbox'>KJ2</option>";
                                                            } ?>
                                                        </select>
                                                    </div>
                                                </div>
