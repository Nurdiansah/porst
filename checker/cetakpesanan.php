...
<!-- Setting Margin header/ kop -->
  ...
  <table>
  <tr>
      <th rowspan="3"><img src="../gambar/logoenc.png" style="width:100px;height:100px" /></th>
      <td align="center" style="width: 520px;"><font style="font-size: 18px"><b>PT. EKANURI  <br> SHOREBASE KALIJAPAT 4</b></font>
      <br><br>Jl. Ketel Uap I No. 1 Jakarta Utara DKI Jakarta <br> Telp :  (021) 439-02157 | Fax : (021) 385-0830</td>
  ...
  <br><br>
  <h4 style="color: black; text-align: center;">Pengeluaran Permintaan Barang dari Divisi : <?= $unit; ?></h4>
  ...
  <p>PIC yang mengambil barang ke Gudang : <?php echo $data2['nama_tukang']; ?></p>
  </div>
  ...
  <div class="kiri">
      <p>Diminta Oleh :<br>Staff  <?= $unit; ?> </p>
      <br>
      <br>
      <br>
      <b><p><u><?php echo $data2['nama_tukang']; ?></u></p></b>
  </div>

  <div class="kanan">
      <p>Disetujui Oleh :<br>Supervisor <?= $unit; ?></p>
      <br>
      <br>
      <br>
