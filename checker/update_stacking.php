<?php  
	...
	if(isset($_POST['update'])) {        
        ...
        $queryDJ =  mysqli_query($koneksi, "SELECT * from detail_stacking WHERE id_cargo  = '$id_cargo'");
        ...
        $query = "INSERT INTO actual_stacking ( id_cargo,  time_as, id_stacking, nm_company_as, nm_barang_as, production_as, no_po_as, p_cargo_as, l_cargo_as, t_cargo_as, volume_cargo_as, ton_cargo_as, revton_cargo_as, qty_cargo_as, satuan_cargo_as, deskripsi_cargo_as, lokasi_awal , lokasi_akhir) VALUES 
										        ( '$id_cargo', '$tanggal', '$id_stacking','$nm_company', '$nm_barang', '$production', '$no_po','$p_cargo', '$l_cargo', '$t_cargo', '$m3_as', '$ton_as', '$revton_as', '$qty_as', '$satuan_cargo', '$deskripsi_cargo', '$lokasi_awal', '$lokasi_akhir');
            ";
            
        $query1 = mysqli_query($koneksi, "UPDATE detail_stacking
