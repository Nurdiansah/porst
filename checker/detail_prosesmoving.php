...
if (isset($_GET['aksi']) && isset($_GET['id_cargo'])) {
    ...
    if ($_GET['aksi'] == 'edit') {
        ...
        $queryHapus = mysqli_query($koneksi, "UPDATE detail_moving SET qty_cargo='0' WHERE id_cargo='$id_cargo' ");
        if ($queryHapus) {
        ...
        <div class="col-sm-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="text-center">Update Internal Moving</h3>
                </div>
                <div class="box-body">
                    <!-- Head -->
                    <div class="row">
                    ...
                    <br>
                    <div class="row">
                        <label id="tes" for="nm_kapal" class=" col-sm-2 control-label">Tanggal</label>
                        <div class="col-sm-3">
                            <input type="text" value="<?= tanggal($row['created_on']); ?>" readonly class="form-control" name="nm_kapal">
                        </div>
                    </div>
                    <br>
                    <div class="row">
                    ...
                    <div class="col-sm-offset-8">
                        ...
                        <?php } else if ($row['status_moving'] == '2') { ?>
                                    ...
                                    <tr>
                                        ...
                                        ?>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="?p=detail_prosesmoving&id=<?= $_GET['id'] ?>&aksi=hapus&id_cargo=<?= base64_encode($row2['id_cargo']); ?>" onclick="javascript: return confirm('Anda yakin ingin menghapus <?= $row2['nm_barang']; ?>?')"><span data-placement='top' data-toggle='tooltip' title='Hapus'><button class="btn btn-danger"> <i class="fa fa-trash"></i> </button></span></a>
                                                </td>
                                    </tr>
                            <?php $no++;
                                            endwhile;
                                    ...
                                    <div class="perhitungan">
                                        <form method="post" name="form" id="insert_form" enctype="multipart/form-data" action="" class="form-horizontal">
                                            <div class="box-body">
                                                ...
                                                <hr>
                                                <input type="hidden" required class="form-control" id="deskripsi_cargo" name="deskripsi_cargo" placeholder="Description">
...
<div class="modal fade" id="modalStart" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="mulai_kegiatan_moving.php" method="post">
                    <input type="hidden" name="id_moving" value="<?= $row['id_moving'] ?>">
...
<div id="modalUpdate" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <!-- body modal -->
            <div class="modal-body">
                <form method="post" enctype="multipart/form-data" action="update_moving.php" class="form-horizontal">
                    <div class="box-body">
...
<div id="modalStop" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <!-- body modal -->
            <div class="modal-body">
                <form method="post" enctype="multipart/form-data" action="stop_moving.php" class="form-horizontal">
                    <div class="box-body">
                        <input type="hidden" value="<?= $id; ?>" class="form-control" name="id_moving" readonly>
                        <div class="mb-3">
...
<div class="modal fade" id="modalContinue" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="continue_kegiatan_moving.php" method="post">
                    <input type="hidden" name="id_moving" value="<?= $id ?>">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
                    <button type="submit" name="submit" class="btn btn-primary">Ya</button>
                </form>
            </div>
...
<div class="modal fade" id="modalFinish" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="finish_kegiatan_moving.php" method="post">
                <div class="modal-body">
                    <div class="form-group ">
                        <label for="keterangan" class="col-sm-offset-1 col-sm-3 control-label">Pilih Checker Penerima</label>
                        <div class="col-sm-5">
                            <select name="id_checker" required class="form-control">
                                <option value="">--Pilih Checker--</option>
                                <?php
                                $queryChecker = mysqli_query($koneksi, "SELECT * FROM user WHERE level = 'unit_pelayanan' AND area = '$Area' AND id_user != '$id_user' ");
...
<script>
    ...
    $(function() {
        $('.modalStop').on('click', function() {
            $('.modal-body form').attr('action', host + 'checker/stop_moving.php')
        });
    });
    // Modal Update
    $(function() {
    ...
    $(function() {
        $('.modalEdit').on('click', function() {
            ...
            $('.modal-body form').attr('action', host + 'checker/edit_dmoving.php')
            $(".submit").show();
