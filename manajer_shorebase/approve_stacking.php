        ...
        <div class="col-sm-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="text-center">Approve Stacking/Stuffing</h3>
                </div>
                <div class="box-body">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        ?>
                                                ...
                                                <td>
                                                    <a href="?p=approve_dstacking&id=<?= base64_encode($row['id_stacking']); ?>"><button class="btn btn-info"> Detail </button></a>
                                                </td>
                                    </tr>
                            <?php $no++;
                                            endwhile;
