...
$query = mysqli_query($koneksi, "SELECT jo.tgl_masuk, jo.kode_jovessel, jo.id_joborder, jo.nm_kapal, c.nm_client , jo.sandar_kapal, jo.status_jo, jo.nm_kegiatan
                                                FROM job_order jo
                                                JOIN client c
                                                ON c.id_client = jo.id_client
                                                WHERE jo.status_jo>=2 AND jo.status_jo<=4
        ...
        <div class="col-sm-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="text-center">PROCESS STEVEDORING</h3>
                </div>
                <div class="box-body">
                    <div class="row">
                        <br><br>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    ?>
                                            ...
                                            <td>
                                                <?php if ($row['status_jo'] == '4') { ?>
                                                    <span class="badge badge-pill badge-warning">Validasi Supervisor</span>
                                                <?php } else { ?>
                                                    <div class="progress">
