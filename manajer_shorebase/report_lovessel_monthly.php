...
<section class="content">
    ...
    <h3 class="text-center">Monthly Report Stevedoring Vessel</h3>
        ...
        <div class="col-sm-4">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <a target="_blank" href="../assets/excel/excel_monthly_vessel.php?id_client=<?= $id_client; ?>&tahun=<?= $tahun; ?>" class="btn btn-success"><i class="fa fa-file-excel-o"></i> Excel </a>
                </div>
            </div>
        </div>
        <!-- End Button -->
