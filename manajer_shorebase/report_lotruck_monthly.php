...
if ($id_client == 'all') {
    for ($i = 1; $i <= 12; $i++) {
        $queryTotal = mysqli_query($koneksi, "SELECT sum(total_cargo) AS jumlah FROM job_ordertruck WHERE month(finish_kegiatan)= $i AND year(finish_kegiatan)= $tahun ");
    ...
    for ($i = 1; $i <= 12; $i++) {
        $queryTotal = mysqli_query($koneksi, "SELECT sum(total_cargo) AS jumlah FROM job_ordertruck WHERE id_client = '$id_client' AND month(finish_kegiatan)= $i AND year(finish_kegiatan)= $tahun ");
        $dataTotal = mysqli_fetch_assoc($queryTotal);
        $total = $dataTotal['jumlah'];
...
<section class="content">
    <div class="row">
        <div class="col-sm-6">
            ...
            <a href="index.php?p=report_lotruck_annual"><button type="button" class="btn btn-danger"><i class="fa fa-calendar"> Annual</i></button></a>
        </div>
    </div>
    <br>
    <div class="row">
    ...
    <h3 class="text-center">Monthly Report Loading Offloading Truck</h3>
    ...
    <div class="row ">
        ...
        <div class="col-sm-8 ">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="text-center">Table Monthly Report</h3>
                </div>
                <div class="box-body">
        ...
        <div class="col-sm-4">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <a target="_blank" href="../assets/excel/excel_monthly_lotruck.php?id_client=<?= $id_client; ?>&tahun=<?= $tahun; ?>" class="btn btn-success"><i class="fa fa-file-excel-o"></i> Excel </a>
                </div>
            </div>
        </div>
        <!-- End Button -->
