...
<!-- Setting Margin header/ kop -->
  ...
  <table class="tabel2 text-center" align="center"  >
    ...
    <tbody>
      ...
      <?php    
        $queryts = mysqli_query($koneksi, "SELECT time_as, doc_no_as, sum(qty_as) as qty_as, rincian_cargo, remarks_as, keterangan, sum(m3_as) as m3_as, sum(ton_as) as ton_as, sum(revton_as) as revton_as
        FROM actual_stevedoring WHERE id_joborder = '$idJoborder'
      ...
      <tr>
        ...
        <td style="text-align: center; width=30px;"><?php echo $row['doc_no_as']; ?></td>
        <td style="text-align: center; width=10px;"><?php echo $row['qty_as']; ?></td>
