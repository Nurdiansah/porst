...
$queryDetail = mysqli_query($koneksi, "SELECT * FROM detail_staclomg WHERE id_stacking = '$id' AND qty_cargo >0 ");
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            ...
                            <br>
                            <a target="_blank" href="../assets/tcpdf/cetak_tallysheetstacking.php?id=<?= $id; ?>" class="btn btn-success"><i class="fa fa-print"></i> Tally Sheet </a>
                        </div>
                    </div>
                </div>
                <br>
                ...
                <div class="table-responsive">
                    <table class="table text-center table table-striped table-hover" id="">
                        ...
                        <tr style="background-color :#B0C4DE;">
                            <td colspan="10">
                                <h4><b>Total Cargo</b></h4>
                            </td>
                            <td>
                                <h4><b><?= $row['total_cargo']; ?></b></h4>
                            </td>
                        </tr>
                    </table>
                </div>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" enctype="multipart/form-data" action="setuju_stacking.php" class="form-horizontal">
                            <div class="box-body">
        ...
        <div id="tolak" class="modal fade" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <!-- body modal -->
                    <div class="modal-body">
                        <form method="post" enctype="multipart/form-data" action="tolak_stacking.php" class="form-horizontal">
                            <div class="box-body">
                                <div class="form-group ">
