...
if (mysqli_num_rows($queryClient)) {
    while ($Client = mysqli_fetch_assoc($queryClient)) :
        ...
        $queryTotal = mysqli_query($koneksi, "SELECT sum(total_cargo) AS jumlah FROM job_order WHERE id_client = '$id_client'  AND year(finish_kegiatan)= $tahun ");
...
<section class="content">
    ...
    <h3 class="text-center">Annual Report Stevedoring Vessel</h3>
    ...
    <div class="row ">
        ...
        <div class="col-sm-8 ">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="text-center">Table Annual Report</h3>
                </div>
                <div class="box-body">
        ...
        <div class="col-sm-4">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <a target="_blank" href="../assets/excel/excel_annual_vessel.php?tahun=<?= $tahun; ?>" class="btn btn-success"><i class="fa fa-file-excel-o"></i> Excel </a>
                </div>
            </div>
        </div>
        <!-- End Button -->
