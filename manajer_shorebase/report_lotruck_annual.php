...
<section class="content">
    <div class="row">
        <div class="col-sm-6">
            ...
            <a href="index.php?p=report_lotruck_monthly"> <button type="button" class="btn btn-success"><i class="fa fa-clock-o"> Monthly</i></button></a>
    ...
    <h3 class="text-center">Annual Report Loading Offloading Truck</h3>
    ...
    <div class="row ">
        ...
        <div class="col-sm-8 ">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="text-center">Table Annual Report Loading Offloading Truck</h3>
                </div>
                <div class="box-body">
        ...
        <div class="col-sm-4">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <a target="_blank" href="../assets/excel/excel_annual_lotruck.php?tahun=<?= $tahun; ?>" class="btn btn-success"><i class="fa fa-file-excel-o"></i> Excel </a>
                </div>
            </div>
        </div>
        <!-- End Button -->
