...
function fetch_data()
{
  ...
  $sql = "SELECT deskripsi_cargo_as, keterangan_as, no_po_as, nm_barang_as, p_cargo, l_cargo, t_cargo, sum(st.volume_cargo_as) as volume_cargo_as, sum(st.ton_cargo_as) as ton_cargo_as, sum(st.revton_cargo_as) as revton_cargo_as
          FROM detail_stacking ds
          JOIN actual_stacking st
          ON ds.id_cargo = st.id_cargo
          WHERE ds.id_stacking = '$idJoborder'
  ...
  while ($row = mysqli_fetch_array($result)) {
    ...
    $output .= "<tr>
                  ...
                  <td style='text-align: center;'>" . $row['keterangan_as'] . "</td>
  ...
  $output .= "<tr >
                  <td style='text-align: center; colspan=\"8\";'><h3><b>Total</b> </h3></td>
...
$obj_pdf->SetTitle("Tally Sheet Stacking");
...
$content .= '<table border="0" cellspacing="0" cellpadding="3" style="color: #4169E1">
    ...
    <tr>  
      <td>Time</td>
      <td>= &nbsp;' . getJam($rowData['mulai_kegiatan']) . ' - ' . getJam($rowData['finish_kegiatan']) . ' ( ' . $rowData['durasi'] . ')</td>
    </tr>
    <tr>  
      <td>Equipment</td>
...
$content .= '
    <table border="1" color="#4169E1" cellpadding="1" align="center" vertical-align="middle">
      <tr>
        ...
        <th rowspan="2"; style="vertical-align: middle; width: 150px;" >Descriptin Of Work</th>
        <th rowspan="2"; style="vertical-align: middle; width: 90px;" >Location<br>(from/to)</th>
    		<th rowspan="2"; style="vertical-align: middle; width: 50px;" >MTD /<br>PO#</th>
        <th rowspan="2"; style="vertical-align: middle; width: 90px;" >Package</th>
        <th colspan="3"; style="vertical-align: middle; width: 150px;">Dimention</th>
        <th rowspan="2"; style="vertical-align: middle; width: 60px;" >Volume<br>M3</th>
        <th rowspan="2"; style="vertical-align: middle; width: 60px;" >Ton</th>
        <th rowspan="2"; style="vertical-align: middle; width: 60px;" >Revton</th>
        <th rowspan="2"; style="vertical-align: middle; width: 70px;" >Sign</th>
      </tr>
      <tr>
        <th>P</th>
        <th>L</th>
...
$content .= '
              <table border="0" cellpadding="3" style="color: #4169E1">
                <tr>
                  ...
                  <th style="text-align: center; width: 400px;">Checker<br><br><br><br><br>(............................................)</th>
                  <th style="text-align: center; width: 200px;">Supervisor<br><br><br><br><br>(............................................)</th>
                </tr>
              </table>';

$obj_pdf->writeHTML($content);
$obj_pdf->Output($idJoborder . '-TallySheetStacking-.pdf', 'I');
