...
function fetch_data()
{
  ...
  $sql = "SELECT deskripsi_cargo_at, production_at, nm_company_at, time_at, keterangan_at, no_po_at, nm_barang_at, satuan_cargo, p_cargo, l_cargo, t_cargo, sum(ac.qty_cargo_at) as qty_cargo,sum(ac.volume_cargo_at) as volume_cargo_at, sum(ac.ton_cargo_at) as ton_cargo_at, sum(ac.revton_cargo_at) as revton_cargo_at
  ...
  $output .= "<tr>
                  <td style='text-align: center; colspan=\"11\";'><h3><b>Total</b></h3> </td>
...
$content .= ' 
    <table border="1" color="#4169E1" cellpadding="1" align="center" vertical-align="middle">
      <tr>        
        ...
        <th rowspan="2"; style="vertical-align: middle; width: 120px;" >Company</th>
        ...
        <th rowspan="2"; style="vertical-align: middle; width: 50px;" >Volume<br>M3</th>
        <th rowspan="2"; style="vertical-align: middle; width: 50px;" >Ton</th>
        <th rowspan="2"; style="vertical-align: middle; width: 50px;" >Revton</th>
        <th rowspan="2"; style="vertical-align: middle; width: 50px;" >Sign</th>
      </tr>
      <tr>
        <th>P</th>
        <th>L</th>
