...
function fetch_data()
{
  ...
  $sql = "SELECT deskripsi_cargo_as, keterangan_as, no_po_as, nm_barang_as, p_cargo, l_cargo, t_cargo, lokasi_awal, lokasi_akhir, sum(st.volume_cargo_as) as volume_cargo_as, sum(st.ton_cargo_as) as ton_cargo_as, sum(st.revton_cargo_as) as revton_cargo_as
